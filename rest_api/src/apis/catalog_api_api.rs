...
pub async fn create_namespace(configuration: &configuration::Configuration, prefix: &str, create_namespace_request: Option<crate::models::CreateNamespaceRequest>) -> Result<crate::models::CreateNamespaceResponse, Error<CreateNamespaceError>> {
...
pub async fn list_namespaces(configuration: &configuration::Configuration, prefix: &str, parent: Option<&str>) -> Result<crate::models::ListNamespacesResponse, Error<ListNamespacesError>> {
    let local_var_configuration = configuration;
...
pub async fn list_tables(configuration: &configuration::Configuration, prefix: &str, namespace: &str) -> Result<crate::models::ListTablesResponse, Error<ListTablesError>> {
    let local_var_configuration = configuration;
...
pub async fn load_namespace_metadata(configuration: &configuration::Configuration, prefix: &str, namespace: &str) -> Result<crate::models::GetNamespaceResponse, Error<LoadNamespaceMetadataError>> {
    let local_var_configuration = configuration;
...
pub async fn load_table(configuration: &configuration::Configuration, prefix: &str, namespace: &str, table: &str, snapshots: Option<&str>) -> Result<crate::models::LoadTableResult, Error<LoadTableError>> {
    let local_var_configuration = configuration;
...
pub async fn update_properties(configuration: &configuration::Configuration, prefix: &str, namespace: &str, update_namespace_properties_request: Option<crate::models::UpdateNamespacePropertiesRequest>) -> Result<crate::models::UpdateNamespacePropertiesResponse, Error<UpdatePropertiesError>> {
    let local_var_configuration = configuration;
...
pub async fn update_table(configuration: &configuration::Configuration, prefix: &str, namespace: &str, table: &str, commit_table_request: Option<crate::models::CommitTableRequest>) -> Result<crate::models::CommitTableResponse, Error<UpdateTableError>> {
    let local_var_configuration = configuration;
