...
impl ReportMetricsRequest {
    pub fn new(report_type: String, table_name: String, snapshot_id: i64, filter: crate::models::Expression, schema_id: i32, projected_field_ids: Vec<i32>, projected_field_names: Vec<String>, metrics: ::std::collections::HashMap<String, crate::models::MetricResult>, sequence_number: i64, operation: String) -> ReportMetricsRequest {
