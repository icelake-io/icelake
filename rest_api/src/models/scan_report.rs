...
impl ScanReport {
    pub fn new(table_name: String, snapshot_id: i64, filter: crate::models::Expression, schema_id: i32, projected_field_ids: Vec<i32>, projected_field_names: Vec<String>, metrics: ::std::collections::HashMap<String, crate::models::MetricResult>) -> ScanReport {
        ScanReport {
            table_name,
            snapshot_id,
